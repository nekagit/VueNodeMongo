...
import { closeIcon, errorIcon, infoIcon, successIcon, warningIcon } from '../common/icons'
...
../ui/src/composables/useColors../ui/src/composables/useTheme../ui/src/common/icons